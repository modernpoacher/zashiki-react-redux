...
describe('#zashiki-react-redux/app/actions/stages/omega', () => {
  const MOCK_REDIRECT = {}
  const MOCK_ROUTE = {}
  const MOCK_ROUTER = {}
  const MOCK_RESOURCE = {}
  ...
  describe('`omegaRoute()`', () => {
    it('returns the action', () => {
      expect(omegaRoute(MOCK_REDIRECT, MOCK_ROUTER))
        .toEqual({
          type: 'MOCK ROUTE',
  ...
  describe('`store()`', () => {
    it('returns the `storeRoute` action', () => {
      expect(store(MOCK_RESOURCE, MOCK_RESPONSE, MOCK_ROUTER))
        .toEqual({
          type: 'MOCK STORE',
          route: {
  ...
  describe('`change()`', () => {
    it('returns the `changeState` action', () => {
      expect(change(MOCK_RESOURCE, MOCK_RESPONSE, MOCK_ROUTER))
        .toEqual({
          type: 'MOCK CHANGE',
          route: {
            resource: MOCK_RESOURCE,
  ...
  describe('`submit()`', () => {
    it('returns the `submitState` action', () => {
      expect(submit(MOCK_RESOURCE, MOCK_RESPONSE, MOCK_ROUTER))
        .toEqual({
          type: 'MOCK SUBMIT',
          route: {
            resource: MOCK_RESOURCE,
