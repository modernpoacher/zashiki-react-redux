 ...
 *  Set `history` `route` from action
 */
export const changeState = ({ status = PENDING, ...state } = {}, { history, debark = {} } = {}) => ({ status, ...state, history, response: { ...debark } })

/*
 *  Get all from state
 *  Set `history` `route` from action
 */
export const submitState = ({ status = PENDING, ...state } = {}, { history, debark = {} } = {}) => ({ status, ...state, history, ...debark })
