...
jest.mock('#app/actions/stages/confirm', () => ({
  ROUTE: 'MOCK ROUTE',
  FETCH: 'MOCK FETCH',
  STORE: 'MOCK STORE',
  SUBMIT: 'MOCK SUBMIT',
...
describe('#app/reducers/stages/confirm', () => {
    ...
    describe('With parameters', () => {
      describe('The action `type` is `ROUTE`', () => {
        it('returns the state', () => {
          expect(confirmReducer({ ...DEFAULT }, { type: 'MOCK ROUTE', history: 'MOCK HISTORY', redirect: 'MOCK REDIRECT' }))
      ...
      describe('The action `type` is `FETCH`', () => {
        it('returns the state', () => {
          expect(confirmReducer({ ...DEFAULT }, { type: 'MOCK FETCH', history: 'MOCK HISTORY', redirect: 'MOCK REDIRECT' }))
            .toEqual({ status: 'MOCK PENDING', history: 'MOCK HISTORY', redirect: 'MOCK REDIRECT' })
        })
      })
      ...
      describe('The action `type` is `STORE`', () => {
        it('returns the state', () => {
          expect(confirmReducer({ ...DEFAULT }, { type: 'MOCK STORE', history: 'MOCK HISTORY', route: { mockField: 'MOCK VALUE' } }))
      ...
      describe('The action `type` is `SUBMIT`', () => {
        it('returns the state', () => {
          expect(confirmReducer({ ...DEFAULT }, { type: 'MOCK SUBMIT', confirm: { mockField: 'MOCK VALUE' } }))
      ...
      describe('The action `type` is `FETCH_FULFILLED`', () => {
        it('returns the state', () => {
          expect(confirmReducer({ ...DEFAULT }, { type: 'MOCK FETCH FULFILLED', response: { mockField: 'MOCK VALUE' } }))
      ...
      describe('The action `type` is `STORE_FULFILLED`', () => {
        it('returns the state', () => {
          expect(confirmReducer({ ...DEFAULT }, { type: 'MOCK STORE FULFILLED', response: { mockField: 'MOCK VALUE' } }))
            .toEqual({ status: 'MOCK RESOLVED', mockField: 'MOCK VALUE' })
        })
      })
      ...
      describe('The action `type` is `SUBMIT_FULFILLED`', () => {
        it('returns the state', () => {
          expect(confirmReducer({ ...DEFAULT }, { type: 'MOCK SUBMIT FULFILLED', response: { mockField: 'MOCK VALUE' } }))
            .toEqual({ status: 'MOCK RESOLVED', mockField: 'MOCK VALUE' })
        })
      })
      ...
      describe('The action `type` is `FETCH_REJECTED`', () => {
        it('returns the state', () => {
          expect(confirmReducer({ ...DEFAULT }, { type: 'MOCK FETCH REJECTED', error: { mockField: 'MOCK FIELD' } }))
      ...
      describe('The action `type` is `STORE_REJECTED`', () => {
        it('returns the state', () => {
          expect(confirmReducer({ ...DEFAULT }, { type: 'MOCK STORE REJECTED', error: { mockField: 'MOCK FIELD' } }))
            .toEqual({ status: 'MOCK REJECTED', exception: { mockField: 'MOCK FIELD' } })
        })
      })
      ...
      describe('The action `type` is `SUBMIT_REJECTED`', () => {
        it('returns the state', () => {
          expect(confirmReducer({ ...DEFAULT }, { type: 'MOCK SUBMIT REJECTED', error: { mockField: 'MOCK FIELD' } }))
            .toEqual({ status: 'MOCK REJECTED', exception: { mockField: 'MOCK FIELD' } })
        })
      })
    })
  ...
  describe('`submit()`', () => {
    it('returns the state', () => {
      expect(submit({ ...DEFAULT, mockStateField: 'MOCK STATE VALUE' }, { history: 'MOCK HISTORY', confirm: { mockActionField: 'MOCK ACTION VALUE' } }))
        .toEqual({
          status: 'MOCK PENDING',
          mockStateField: 'MOCK STATE VALUE',
          history: 'MOCK HISTORY',
