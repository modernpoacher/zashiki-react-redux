...
describe('@modernpoacher/zashiki-react-redux/app/components/stages/omega/stage', () => {
  describe('Always', () => {
    it('renders', () => {
      const component = (
        <Stage definition={{}} resource={{}} onChange={jest.fn()} onSubmit={jest.fn()} />
      )
  ...
  describe('`state` is an object', () => {
    describe('`count` is an integer', () => {
      it('renders', () => {
        const component = (
          <Stage definition={{}} resource={{}} onChange={jest.fn()} onSubmit={jest.fn()} state={{ count: 1, index: 0 }} />
        )
    ...
    describe('`index` is an integer', () => {
      it('renders', () => {
        const component = (
          <Stage definition={{}} resource={{}} onChange={jest.fn()} onSubmit={jest.fn()} state={{ count: 0, index: 1 }} />
        )
    ...
    describe('`count` is an integer and `index` is an integer', () => {
      it('renders', () => {
        const component = (
          <Stage definition={{}} resource={{}} onChange={jest.fn()} onSubmit={jest.fn()} state={{ count: 1, index: 1 }} />
        )
