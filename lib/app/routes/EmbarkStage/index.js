...
import * as EmbarkStageActions from '../../actions/embark-stage'
...
class EmbarkStagePage extends React.Component {
  ...
  render () { // // console.log('(EmbarkStagePage)render()') // eslint-disable-line
    const {
      [ROUTE_MASTER_EMBARK_STATE]: embark
    } = this.props
...
export default connect(
  ({ [ROUTE_MASTER_EMBARK_STATE]: embark }) => ({ [ROUTE_MASTER_EMBARK_STATE]: embark })
)(EmbarkStagePage)
