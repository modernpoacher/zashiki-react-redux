...
const ROUTE_MASTER_DEBARK = 'ROUTE_MASTER_DEBARK' // /^ROUTE_MASTER_DEBARK$/
const ROUTE_MASTER_EMBARK = 'ROUTE_MASTER_EMBARK' // /^ROUTE_MASTER_EMBARK$/
const ROUTE_MASTER = 'ROUTE_MASTER_QUERY' // /^ROUTE_MASTER_QUERY$/
...
const redirectRoute = ({ routeMaster: { redirect } }) => { // console.log('redirectRoute()', redirect) // eslint-disable-line
